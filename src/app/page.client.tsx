...
import { getAuth, signInWithPopup, GoogleAuthProvider, AuthError, User, Auth } from 'firebase/auth';
import { Database, endBefore, get, getDatabase, limitToLast, onValue, orderByChild, push, query, ref, serverTimestamp } from 'firebase/database';
...
export default function HomeClient({ firebaseConfig }: HomeClientProps) {
